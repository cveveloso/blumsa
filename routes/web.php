...
Route::post('/admin/catalog/products/images/upload', [AdminProductController::class, 'UploadImagesProduct'])->name('/admin/catalog/products/images/upload');
Route::post('/admin/catalog/products/images/delete/{id}', [AdminProductController::class, 'DeleteImagesProduct'])->name('/admin/catalog/products/images/delete');
