				  ...
				  <div class="tab-content" id="langTabContent">
					...
					<div class="tab-pane fade {{ $firstPanel }}" id="panel-{{$key}}" role="tabpanel" aria-labelledby="tab-{{$key}}">
					  ...
					  <div class="input-group mb-2">
						  ...
						  {!! Form::textarea('description-' . $key, old('description-' . $key ,$categoryDescription->description), ['class' =>'form-control summernote' . ($errors->has('description-' . $key) ? ' border-danger' : ''), 'rows' => 4]) !!}
					  </div>
					  @php 					
