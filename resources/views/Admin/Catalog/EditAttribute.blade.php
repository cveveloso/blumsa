...
@section('title', Lang::get('admin.editattribute'))
@section('headtitle', Lang::get('admin.editattribute'))

@section('toolbar')
{!! Form::open(['url' => '/admin/catalog/attribute/update/' . $attribute->id_attribute]) !!}
			  ...
			  <h5 class="card-title card-custom-title">Nombre y grupo</h5>
					...
					<div class="tab-content" id="adminTabContent">   		
						<div class="tab-pane fade show active" id="panel-data" role="tabpanel" aria-labelledby="tab-data">
							...
							<div class="tab-content" id="langTabContent">
								@foreach(array_keys(Config::get('languages')) as $key)
								@php 
								$attributeDescription = $attribute->Descriptions($key);
								@endphp								
								...
								<div class="input-group mb-2">
									...
									{!! Form::text('name-' . $key, old('name-' . $key ,$attributeDescription->name), ['class' =>'form-control' . ($errors->has('name-' . $key) ? ' border-danger' : '')]) !!}
								</div>
								@php 					
				...
				<div class="form-group">	
					...
					<div class="input-group mb-2">
						...
						{!! Form::select('group', $comboGroups, old('group', $attribute->id_attribute_group), ['class' =>'form-control' . ($errors->has('group') ? ' border-danger' : '')])  !!}
					</div>
					@php 					
						if ($errors->has('group')) { 
						...
						<div class="col" style="max-width:250px;">
							<div class="form-group">
								...
								<div class="input-group mb-2">
									...
									{!! Form::number('sort_order', old('sort_order', $attribute->sort_order), ['class' =>'form-control' . ($errors->has('sort_order') ? ' border-danger' : '')])  !!}
								</div>
								@php 					
						...
						<div class="col" style="max-width:250px;">
							<div class="form-group">
								...
								<div class="input-group mb-2">
									...
									{!! Form::select('data_type', array("number" => "Numerico","text" => "Texto libre"), old('data_type', $attribute->data_type), ['class' =>'form-control' . ($errors->has('data_type') ? ' border-danger' : '')])  !!}
								</div>
								@php 					
						...
						<div class="col" style="max-width:250px;">
							<div class="form-group">
								...
								<div class="input-group mb-2">
									...
									{!! Form::select('unit', array("kg" => "kilogramo","cm" => "Centimetros","vol" => "Centimetros cubicos"), old('unit', $attribute->unit), ['class' =>'form-control' . ($errors->has('unit') ? ' border-danger' : '')])  !!}
								</div>
								@php 					
								if ($errors->has('unit')) { 
